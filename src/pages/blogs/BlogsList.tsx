                    ...
                    {currentBlogs.map((blog: Blog) => (
                        <div key={blog.id} className="border-b border-gray-300 py-4 flex justify-between items-center">
                            ...
                            < div className="flex items-center">
                                <Link to={`/home/blogs/edit/${blog.id}`} className="text-indigo-600 hover:underline">
                                    <FaRegEdit className="text-indigo-600" />
                                </Link>  
                                <button onClick={() => setModalId(blog.id as number)}  className="ml-4 text-red-600 hover:underline">
